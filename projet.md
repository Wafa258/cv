...
Contenir le code JavaScript du jeu.

✅ 2. CSS, il sert à : 
A mettre en forme l’apparence de la page.
Changer la couleur du fond.
Enlever la marge du body.
Styliser le canvas du jeu (bordure, centrage…).

✅ 3. JavaScript, il sert à :
Faire fonctionner la logique du jeu (retourner les cartes, vérifier les paires…).
Il gère : 
1. les niveaux
2. le timer
3. les animations
